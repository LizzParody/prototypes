...
for (var i = 0; i < sentences.length; i++) {
	...
	if (phrase.cliche()) { //Notice that we’re not creating a string using the String constructor and new. JavaScript is converting each string to a String object behind the scenes for us, when we call the cliche method.
